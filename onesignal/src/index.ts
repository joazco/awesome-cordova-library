...
export default class Onesignal {
   ...
   * @returns void
   */
  static setNotificationWillShowInForegroundHandler(handler: (event: NotificationReceivedEvent) => void) {
    if (typeof window.plugins === 'undefined' || typeof window.plugins.OneSignal === 'undefined') {
      Onesignal.warnPluginIsUnInstallOrIncompatible();
      return;
    }
   ...
   * @returns void
   */
  static setNotificationOpenedHandler(handler: (openedEvent: OpenedEvent) => void) {
    if (typeof window.plugins === 'undefined' || typeof window.plugins.OneSignal === 'undefined') {
      Onesignal.warnPluginIsUnInstallOrIncompatible();
      return;
    }
   ...
   * @returns void
   */
  static setInAppMessageClickHandler(handler: (action: InAppMessageAction) => void) {
    if (typeof window.plugins === 'undefined' || typeof window.plugins.OneSignal === 'undefined') {
      Onesignal.warnPluginIsUnInstallOrIncompatible();
      return;
    }
   ...
   * @returns void
   */
  static requiresUserPrivacyConsent(handler: (response: boolean | { value: boolean }) => void): void {
    if (typeof window.plugins === 'undefined' || typeof window.plugins.OneSignal === 'undefined') {
      Onesignal.warnPluginIsUnInstallOrIncompatible();
      return;
    }
   ...
   * @returns void
   */
  static isLocationShared(handler: (response: boolean | { value: boolean }) => void): void {
    if (typeof window.plugins === 'undefined' || typeof window.plugins.OneSignal === 'undefined') {
      Onesignal.warnPluginIsUnInstallOrIncompatible();
      return;
    }
